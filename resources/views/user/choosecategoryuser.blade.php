    ...
    <div class="main">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <div class="">
              <h2 style="font-size:60px;">Pasirinkite kategoriją</h2>
                @foreach($categories as $category)
                <td class="">
                <a class= "btn btn-lg btn-block categorybutton" href="{{url('choosesubcategoryuser',$category->category_id)}}">{{$category->name}}</a>
                </td>
