...
-->
  ...
  <body>
    ...
    <!-- Page Content -->
        ...
        <form action="{{url('addcredit', $data->senior_id)}}" method="post" enctype="multipart/form-data " class="payment">
            @csrf
            <div class="mt-4">
            ...
            <div class="mt-4">
                ...
                <input value="12345" required id="payment_code" class="block mt-1 payment" type="text" name="payment_code"  required />
            </div>
            <div class="mt-4">
                <label for="user_bill" value="{{ __('Sąskaita') }}" >Sąskaita</label>
                <input value="LT0000000000" required id="user_bill" class="block mt-1 payment" type="text" name="user_bill"  required />
            </div>
