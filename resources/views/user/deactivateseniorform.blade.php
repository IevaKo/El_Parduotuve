  ...
  <body>
    ...
    <header class="navbar flex-row ml-md-auto d-none d-md-flex">
      ...
      @if(session()->has('message'))
        ...
        <div>
            <h1>Ar tikrai norite deaktyvuoti senjoro anketą: {{$senior->login}}?</h1>
            <button><a class= "btn btn-success" href="{{url('deactivatesenior',$senior->senior_id)}}">Taip</a></button>
            <button><a class= "btn btn-danger" href="{{url('showsenior')}}">Ne</a></button>
        </div>
